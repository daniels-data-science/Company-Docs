...
1. Alerting the carer or nurse if a patient falls.
2. Having a profiling system to capture, edit and search patients.
3. Allowing each user to define the patient, carer and Admin users.
4. Live updating of patient current activity.
