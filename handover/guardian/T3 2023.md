...
- [Project Handover Document](#project-handover-document)
  ...
  - [AI-driven System](#ai_driven_system)
    - [AI Pipeline's Logistics](#ai_pipeline_logistics)
    - [Data Familiarisation](#'data_familiarisation')
    - [Data Preprocessing](#'data_preprocessing')
    - [Feature Extraction](#'feature_extraction')
    - [Classication Model](#'classification_model')
  - [Roadmap](#roadmap)
...
* The raw data that enters the offline pipeline will be from public dataset(s). This is opposed to the raw data that enters the online pipeline, which is real-time.
