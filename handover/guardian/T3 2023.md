...
2. Have a profiling system to capture, edit and search patients.
3. Allowing each user to define the patient, carer and Admin users.
4. Live monitoring of patient activity.
5. Generating dashboards about patient activity history.
6. Detecting changes in patients' physical health to provide referrals accordingly.
